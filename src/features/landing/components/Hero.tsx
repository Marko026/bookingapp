              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-amber-700">
                {t('title_word_4')}
							...
							<div className="md:hidden absolute left-[55%] sm:left-[65%] top-[5%] w-[45%] sm:w-[30%] h-40 pointer-events-none overflow-visible z-20">
								...
								>
									<Image src="/main-img.png" alt="A1" fill className="object-cover" />
								</motion.div>
								...
								>
									<Image src="https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?q=80&w=400&auto=format&fit=crop" alt="A2" fill className="object-cover" />
								</motion.div>
								...
								>
									<Image src="/main-img1.png" alt="A3" fill className="object-cover" />
								</motion.div>
								...
								>
									<Image src="/main-img.png" alt="A4" fill className="object-cover" />
								</motion.div>
							</div>            </h1>
